  ...
  >
    ...
    >
      <li
        ...
        :key="order.id"
        class="bg-black/5 dark:bg-gray-500/20 border border-black/10 dark:border-gray-500/20 p-3 rounded-2xl overflow-hidden flex flex-col gap-3"
      >
        ...
        >
          ...
          <ul class="mt-3 flex flex-col gap-2">
            <li
              ...
              :key="comment.uuid"
              class="rounded-xl bg-black/5 dark:bg-gray-500/10 p-3"
            >
